  ...
  const copy =
    language === "pt"
      ? {
          ...
          text:
            "Sou Full Stack Software Engineer com mais de 4 anos de experiência em aplicações web escaláveis, seguras e de alta performance. Especialista em .NET (ASP.NET Core) no backend e Angular & React no frontend, com experiência sólida em Node.js e PHP (Laravel + Blade). Atuei em sistemas corporativos, plataformas de gestão e dashboards, sempre com foco em clean code, performance e manutenibilidade. Atualmente aberto a oportunidades remotas como Software Engineer, Senior Frontend Developer ou Full Stack Engineer, colaborando com times globais e stacks modernas.",
          cta: "Vamos conversar",
        }
      : {
          title: "About me",
    ...
    <Section id="about" title={copy.title}>
      <div className="grid gap-10 sm:grid-cols-2 items-center">
        ...
        <div>
          ...
          <a href="#contact" className="mt-6 inline-block btn-accent rounded-full px-4 py-2 text-sm font-medium">{copy.cta}</a>
        </div>
      </div>
    </Section>
  );
